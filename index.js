...
// === Перевод (кнопка "🌐 Перевести") через MyMemory, бесплатно без ключа ===
// Лимиты: анонимно 5 000 слов/сутки на IP, с email в параметре de — 50 000/сутки на этот email.
// Впиши сюда один или несколько своих email, чтобы поднять лимит; при нескольких — round-robin
// с автопереключением на следующий при "лимит исчерпан". Пусто = анонимный режим.
