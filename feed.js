...
export function renderPostOverlay() {
    ...
    // Сбрасываем white-space в normal и возвращаем системный шрифт интерфейса вместо стилей читалки
    contentEl.style.cssText = postBackgroundStyle(post) + 'border-radius:16px;padding:' + (postBackgroundStyle(post) ? '14px;' : '0;') + ';white-space:normal;line-height:1.5;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;';
    contentEl.innerHTML = `
        ${authorBlock} 
        ${imagesHtml}
        ...
        <div class="comments-block">
            ...
            ${comments.length ? comments.map(c => `
                <div class="comment-item" style="white-space:normal;">
